...
В незащищенном коде имеется ступеньчатая проверка правильности введенной даты (условие - старше 16 лет, наличие точек на своих местах и цифр на своих позициях в определенных диапазонах). В защищенном коде данная проверка реализована мною лишь частично - иначе логика алгоритма может быть раскрыта быстрее.
